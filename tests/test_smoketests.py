...
class TestSmoketests():
  ...
  def test_homepage1(self):
    ...
    self.driver.set_window_size(785, 672)
  ...
  def test_adminpage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("example")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Max")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Nvani")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("example")
